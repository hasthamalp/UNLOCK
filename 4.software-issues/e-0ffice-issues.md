...
{% hint style="danger" %}
There is a problem with this Windows Installer package.A program run as part of the setup did not finish as expected.Contact your support of package vendor .
{% endhint %}
